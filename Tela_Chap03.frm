VERSION 5.00
Begin VB.Form Tela_Chap03 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Chapinha Modelo 3: Globo de 1/2"", 3/4"" e 1"""
   ClientHeight    =   6735
   ClientLeft      =   45
   ClientTop       =   315
   ClientWidth     =   4455
   ...
   Begin VB.Frame FR_Posicao 
      ...
      Begin VB.TextBox TXT_Y_SEDE 
         ...
         Width           =   615
      End
      Begin VB.TextBox TXT_Y_CONTRASEDE 
         Alignment       =   2  'Center
         Height          =   285
         Left            =   3360
         TabIndex        =   43
      ...
      Begin VB.TextBox TXT_X_SEDE 
         ...
         Width           =   615
      End
      Begin VB.TextBox TXT_X_CONTRASEDE 
         Alignment       =   2  'Center
         Height          =   285
         Left            =   2280
         TabIndex        =   27
      ...
      Begin VB.OptionButton RB_HASTE 
         ...
         Width           =   1695
      End
      Begin VB.OptionButton RB_CONTRASEDE 
         Caption         =   "CONTRA-SEDE"
         Height          =   255
         Left            =   120
         TabIndex        =   6
...
Private Sub BT_Salvar_Click()
    ...
    EscreveINI SVAR_ARQUIVO_POSICAO, "CONTRASEDE", "X", TXT_X_CONTRASEDE.Text
    EscreveINI SVAR_ARQUIVO_POSICAO, "CONTRASEDE", "Y", TXT_Y_CONTRASEDE.Text
...
Private Sub Form_Load()
    ...
    TXT_X_CONTRASEDE.Text = LeINI(SVAR_ARQUIVO_POSICAO, "CONTRASEDE", "X")
    TXT_Y_CONTRASEDE.Text = LeINI(SVAR_ARQUIVO_POSICAO, "CONTRASEDE", "Y")
...
Private Sub AtualizaCamposPosicao()
    ...
    ElseIf RB_CONTRASEDE.Value = True Then
        TXT_X_CONTRASEDE.Text = IVAR_PASSO_X
        TXT_Y_CONTRASEDE.Text = IVAR_PASSO_Y
