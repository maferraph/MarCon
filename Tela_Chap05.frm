VERSION 5.00
Begin VB.Form Tela_Chap05 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Chapinha Modelo 5: Retenção Pistão (todas)"
   ClientHeight    =   5760
   ClientLeft      =   45
   ClientTop       =   315
   ClientWidth     =   4455
   ...
   Begin VB.Frame FR_Posicao 
      ...
      Begin VB.OptionButton RB_SEDE 
         ...
         Width           =   1695
      End
      Begin VB.OptionButton RB_PISTAO 
         Caption         =   "PISTÃO"
         Height          =   255
         Left            =   120
         TabIndex        =   5
...
Private Sub BT_Salvar_Click()
    ...
    EscreveINI SVAR_ARQUIVO_POSICAO, "PISTAO", "X", TXT_X_PISTAO.Text
    EscreveINI SVAR_ARQUIVO_POSICAO, "PISTAO", "Y", TXT_Y_PISTAO.Text
    EscreveINI SVAR_ARQUIVO_POSICAO, "SEDE", "X", TXT_X_SEDE.Text
    EscreveINI SVAR_ARQUIVO_POSICAO, "SEDE", "Y", TXT_Y_SEDE.Text
    EscreveINI SVAR_ARQUIVO_POSICAO, "MOLA", "X", TXT_X_MOLA.Text
    EscreveINI SVAR_ARQUIVO_POSICAO, "MOLA", "Y", TXT_Y_MOLA.Text
...
Private Sub Form_Load()
    ...
    TXT_X_PISTAO.Text = LeINI(SVAR_ARQUIVO_POSICAO, "PISTAO", "X")
    TXT_Y_PISTAO.Text = LeINI(SVAR_ARQUIVO_POSICAO, "PISTAO", "Y")
    TXT_X_SEDE.Text = LeINI(SVAR_ARQUIVO_POSICAO, "SEDE", "X")
    TXT_Y_SEDE.Text = LeINI(SVAR_ARQUIVO_POSICAO, "SEDE", "Y")
    TXT_X_MOLA.Text = LeINI(SVAR_ARQUIVO_POSICAO, "MOLA", "X")
    TXT_Y_MOLA.Text = LeINI(SVAR_ARQUIVO_POSICAO, "MOLA", "Y")
...
Private Sub AtualizaCamposPosicao()
    ...
    ElseIf RB_PISTAO.Value = True Then
        TXT_X_PISTAO.Text = IVAR_PASSO_X
        TXT_Y_PISTAO.Text = IVAR_PASSO_Y
    ElseIf RB_SEDE.Value = True Then
        TXT_X_SEDE.Text = IVAR_PASSO_X
        TXT_Y_SEDE.Text = IVAR_PASSO_Y
    ElseIf RB_MOLA.Value = True Then
        TXT_X_MOLA.Text = IVAR_PASSO_X
        TXT_Y_MOLA.Text = IVAR_PASSO_Y
